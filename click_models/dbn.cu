 ...
 */
HST void DBN_Hst::update_parameters(std::vector<SERP_Hst>& dataset, const std::vector<int>& thread_start_idx) {
 ...
 * @param thread_start_idx Dataset starting indices of each thread.
 */
HST void DBN_Hst::process_session(const std::vector<SERP_Hst>& dataset, const std::vector<int>& thread_start_idx) {
