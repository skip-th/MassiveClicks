 ...
 */
HST void CCM_Hst::init_parameters(const Partition& dataset, const size_t fmem, const bool device) {
 ...
 */
HST void CCM_Hst::update_parameters(TrainSet& dataset, const std::vector<int>& thread_start_idx) {
 ...
 * @param thread_start_idx Dataset starting indices of each thread.
 */
HST void CCM_Hst::process_session(const TrainSet& dataset, const std::vector<int>& thread_start_idx) {
