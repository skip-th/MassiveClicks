 ...
 */
HST void DBN_Hst::reset_parameters(void) {
 ...
 * (H2D or D2H).
 */
HST void DBN_Hst::transfer_parameters(int parameter_type, int transfer_direction) {
    // Public parameters.
 ...
 * type -> Parameters.
 */
HST void DBN_Hst::sync_parameters(std::vector<std::vector<std::vector<Param>>>& parameters) {
